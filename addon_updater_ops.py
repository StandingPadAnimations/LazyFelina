...
updater.addon = "lazyfelina_addon"
...
def register(bl_info):
	...
	updater.repo = "LazyFelina"

	#updater.addon = # define at top of module, MUST be done first

	# Website for manual addon download, optional but recommended to set
	updater.website = "https://github.com/StandingPadAnimations/LazyFelina"
	...
	updater.version_min_update = (8,0,0)
